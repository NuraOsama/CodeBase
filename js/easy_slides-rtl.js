        ...
        if (count > 0) {
            ...
            if (settings['touchevents']) {
                ...
                const EasySliderMoved = function (xcur, ycur) {
                    let right = 0;
                    let bottom = 0;
                    if (this_slider.querySelector('.slide-active:not(.next_button, .prev_button, .nav_indicators ul li)')) {
                        const rect = this_slider.querySelector('.slide-active:not(.next_button, .prev_button, .nav_indicators ul li)').getBoundingClientRect();
